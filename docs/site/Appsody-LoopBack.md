...
The [Appsody CLI](https://appsody.dev/docs/using-appsody/cli-commands/) makes it
extremely easy for a developer to: scaffold, run, stop, debug, test, build, and
deploy an application to a cloud.
